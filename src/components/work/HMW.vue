<template>
    <div class="relative mt-2 mb-8 md:mb-12">
        ...
        <div class=" p-8 lg:px-12 lg:py-10 space-y-4 sm:space-y-6 text-white rounded-[40px] lg:rounded-[56px] bg-stone-900 dark:bg-white dark:text-stone-900">
            <p class="text-center">
            {{ $t('work.title.item6-0') }}
            </p>
